...
$(function () {
    ...
    ClassicEditor.editorConfig = function( config ) {
        config.filebrowserBrowseUrl = './content/common/js/ckeditor/ckfinder/ckfinder.html';
        config.filebrowserImageBrowseUrl = './content/common/js/ckeditor/ckfinder/ckfinder.html?type=Images';
        config.filebrowserFlashBrowseUrl = './content/common/js/ckeditor/ckfinder/ckfinder.html?type=Flash';
        config.filebrowserUploadUrl = './content/common/js/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';
        config.filebrowserImageUploadUrl = './content/common/js/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images';
        config.filebrowserFlashUploadUrl = './content/common/js/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash';
    };
...
class MyUploadAdapter {
    ...
    _initRequest() {
        ...
        // could be different.
        xhr.open( 'POST', 'menus/manage/api_get_parent', true );
