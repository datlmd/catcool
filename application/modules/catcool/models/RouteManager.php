...
use catcool\models\Route;

class RouteManager extends My_DModel
{
    const ENTITY_NAME = 'catcool\models\Route';

    //query su dung trong support tool
    private $_queries = [
        'find_by_all' => 'SELECT e FROM __TABLE_NAME__ e WHERE e.module LIKE :module OR e.resource LIKE :resource ORDER BY e.id DESC',
    ...
    public function get_all_by_filter($filter = null, $limit = 0, $offset = 0)
    {
        ...
        $filter['resource'] = empty($filter['resource']) ? '%%' : '%'.$filter['resource'].'%';
