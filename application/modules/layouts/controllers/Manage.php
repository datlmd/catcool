...
class Manage extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->lang->load('layouts_manage', $this->_site_lang);

        //load model manage
        $this->load->model("layouts/Layout", 'Layout');
    ...
    public function index()
    {
        ...
        list($list, $total) = $this->Layout->get_all_by_filter($filter, $limit, $start_index);
    ...
    public function add()
    {
        ...
        if (isset($_POST) && !empty($_POST) && $this->validate_form() !== FALSE) {
            ...
            $id = $this->Layout->insert($add_data);
            if ($id !== FALSE) {
    ...
    public function edit($id = null)
    {
        ...
        if (isset($_POST) && !empty($_POST) && $this->validate_form() !== FALSE) {
            ...
            if (valid_token() === FALSE || $id != $this->input->post('layout_id')) {
            ...
            if ($this->Layout->update($edit_data, $id) !== FALSE) {
    ...
    public function delete($id = null)
    {
        ...
        if (isset($_POST['is_delete']) && isset($_POST['ids']) && !empty($_POST['ids'])) {
            ...
            $list_delete = $this->Layout->where('id', $ids)->get_all();
        ...
        $list_delete = $this->Layout->where('id', $delete_ids)->get_all();
        if (empty($list_delete)) {
            json_output(['status' => 'ng', 'msg' => lang('error_empty')]);
        }
