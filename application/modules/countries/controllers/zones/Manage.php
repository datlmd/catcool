...
class Manage extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->lang->load('countries_zones_manage', $this->_site_lang);
    ...
    public function index()
    {
        ...
        list($list, $total) = $this->Zone->get_all_by_filter($filter, $limit, $start_index);
    ...
    public function add()
    {
        ...
        if (isset($_POST) && !empty($_POST) && $this->validate_form() !== FALSE) {
            ...
            if ($this->Zone->insert($additional_data) !== FALSE) {
    ...
    public function edit($id = null)
    {
        ...
        if (isset($_POST) && !empty($_POST) && $this->validate_form() !== FALSE) {
            ...
            if ($this->Zone->update($edit_data, $id) !== FALSE) {
    ...
    public function delete($id = null)
    {
        ...
        if (isset($_POST['is_delete']) && isset($_POST['ids']) && !empty($_POST['ids'])) {
            ...
            $list_delete = $this->Zone->where('zone_id', $ids)->get_all();
            ...
            try {
                foreach($list_delete as $value) {
                    $this->Zone->delete($value['zone_id']);
                }
        ...
        $list_delete = $this->Zone->where('zone_id', $delete_ids)->get_all();
        if (empty($list_delete)) {
            json_output(['status' => 'ng', 'msg' => lang('error_token')]);
        }
        ...
        json_output(['data' => theme_view('zones/delete', $data, true)]);
    }
