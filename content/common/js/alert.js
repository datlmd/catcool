...
(function ($) {
    $.alert_ext = {
        ...
        // 提示框模版
        tmpl: '<div class="alert-catcool alert alert-dismissable ${State} fade show"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"><span aria-hidden="true">&times;</span></button><h4 style="white-space: nowrap;">${Title}</h4><p>${Content}</p></div>',
