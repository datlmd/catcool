...
class Dummy_group_manage extends Admin_Controller
{
    protected $errors = [];

    CONST MANAGE_ROOT = 'dummy/dummy_group_manage';
    CONST MANAGE_URL  = 'dummy/dummy_group_manage';
    ...
    public function __construct()
    {
        ...
        //load model manage
        $this->load->model("dummy/Dummy_group", "Dummy_group");
    ...
    public function index()
    {
        ...
        list($list, $total) = $this->Dummy_group->get_all_by_filter($filter, $limit, $start_index);
    ...
    public function add()
    {
        ...
        if (isset($_POST) && !empty($_POST) && $this->validate_form() === TRUE) {
            ...
            $id = $this->Dummy_group->insert($add_data);
            if ($id === FALSE) {
    ...
    public function edit($id = null)
    {
        ...
        if (isset($_POST) && !empty($_POST) && $this->validate_form() === TRUE) {
            ...
            if ($this->Dummy_group->update($edit_data, $id) !== FALSE) {
    ...
    protected function get_form($id = null)
    {
        ...
        if (!empty($id) && is_numeric($id)) {
            ...
            $data_form = $this->Dummy_group->get($id);
            if (empty($data_form)) {
                set_alert(lang('error_empty'), ALERT_ERROR);
                redirect(self::MANAGE_URL);
            }
    ...
    public function delete($id = null)
    {
        ...
        if (isset($_POST['is_delete']) && isset($_POST['ids']) && !empty($_POST['ids'])) {
            ...
            $list_delete = $this->Dummy_group->where('dummy_id', $ids)->get_all();
            if (empty($list_delete)) {
                json_output(['status' => 'ng', 'msg' => lang('error_empty')]);
            }
            try {
                foreach($list_delete as $value){
                    $this->Dummy_group->delete($value['dummy_id']);
                }
        ...
        $list_delete = $this->Dummy_group->where('dummy_id', $delete_ids)->get_all();
        if (empty($list_delete)) {
            json_output(['status' => 'ng', 'msg' => lang('error_empty')]);
        }
        ...
        json_output(['data' => theme_view('group/delete', $data, true)]);
    }
}
