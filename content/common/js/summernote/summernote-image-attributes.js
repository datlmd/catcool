    ...
    $.extend(true,$.summernote.lang,{
        ...
        'es-ES':{ /* Spanish */
            imageAttributes:{
                ...
                title:'Titulo',
                src:'Fuente',
                srcHelp:'La selecciÃ³n de una imagen reemplazarÃ¡ la imagen existente con una imagen Inline.',
                alt:'Alternativo',
                class:'Clases',
                ...
                relAlternate:'Alternate: Enlaza a una versiÃ³n alternativa del documento',
                ...
                relLicense:'License: Enlaza a un documento de informaciÃ³n de Copyright',
                relNext:'Next: Enlaza al siguiente documento en una selecciÃ³n',
                relNofollow:'NoFollow: Enlaza a un documento no confirmado, como un enlace de pago, tambiÃ©n evita que los buscadores sigan este enlace',
                relNoreferrer:'NoReferrer: Specifies that the browser should not send a HTTP Header',
                relPrefetch:'PreFetch: Specifies that the target document should be cached',
                relPrev:'Prev: Enlaza al documento anterior en una selecciÃ³n',
                relSearch:'Search: Enlaza a una herramienta de bÃºsqueda para el documento',
        ...
        'pt-BR':{ /* Spanish */
            imageAttributes:{
                ...
                title:'TÃ­tulo',
                src:'Fonte',
                srcHelp:'Selecionar uma imagem irÃ¡ substituir a imagem existente com uma imagem inline.',
                alt:'Alt',
                class:'Class',
                ...
                linkRole:'Papel',
                rel:'Rel',
                relBlank:'NÃ£o use o atribudo Rel',
                relAlternate:'Alternate: Links para uma versÃ£o alternativa do documento',
                ...
                relLicense:'License: Links para a informaÃ§Ã£o de copyright do documento',
                relNext:'Next: O prÃ³ximo documento em uma seleÃ§Ã£o',
                relNofollow:'NoFollow: Links para um documento nÃ£o confirmado, como um link pago, tambÃ©m impede mecanismos de busca de seguir esse link',
                relNoreferrer:'NoReferrer: Especifica que o navegador nÃ£o deve enviar um cabeÃ§alho HTTP',
                relPrefetch:'PreFetch: Especifica que o documento de destino deve ser cacheado',
                relPrev:'Prev: O documento anterior em uma seleÃ§Ã£o',
        ...
        'fr-FR':{ /* French */
            imageAttributes:{
                ...
                title:'Titre',
                src:'La source',
                srcHelp:'La sÃ©lection d\'une image remplacera l\'image existante par une Image Inline.',
                alt:'Alt',
                class:'Class CSS',
                ...
                relBookmark:'Bookmark: Lien permant utilisÃ© pour les signets',
                ...
                relNofollow:'NoFollow: EmpÃªcher les moteurs de recherche de suivre ce lien',
                relNoreferrer:'NoReferrer: PrÃ©cise que le navigateur ne doit pas envoyer d\'entÃªte HTTP',
                relPrefetch:'PreFetch: PrÃ©cise que le document cible doit Ãªtre mis en cache',
                relPrev:'Prev: La page prÃ©cÃ©dente de ce document',
                relSearch:'Search: Lien vers un outil de recherche du document',
                relTag:'Tag: Mot-clÃ© du document'
            }
        },
        'zh-TW':{ /* Chinese */
            imageAttributes:{
                dialogTitle:'åœ–ç‰‡æç¤º',
                tooltip:'åœ–ç‰‡æç¤º',
                pluginImageTitle:'åœ–ç‰‡å±¬æ€§',
                pluginLinkTitle:'é€£çµå±¬æ€§',
                title:'æ¨™é¡Œ',
                src:'è³‡æº',
                srcHelp:'é¸æ“‡åœ–åƒå°‡ç”¨å…§è¯åœ–åƒæ›¿æ›ç¾æœ‰åœ–åƒ.',
                alt:'åœ–ç‰‡èªªæ˜Ž',
                class:'ç±»',
                classSelect:'é¸æ“‡ ç±»',
                style:'æ ·å¼',
                ...
                linkRole:'è§’è‰²',
                rel:'æè¿°',
                relBlank:'ä¸ä½¿ç”¨é€£çµèªªæ˜Ž',
                rel:'ä¸ä½¿ç”¨éˆçµèªªæ˜Ž',
                relBlank:'ä¸ä½¿ç”¨éˆçµèªªæ˜Ž',
                relAlternate:'æ›¿ä»£èªªæ˜Ž: é€£è‡³æ›¿ä»£èªªæ˜Žæ–‡ä»¶',
                relAuthor:'ä½œè€…: é€£è‡³ä¾†æºä½ç½®',
                relBookmark:'æ›¸ç±¤: æä¾›åŠ å…¥æ›¸ç±¤',
                relHelp:'å¹«åŠ©: é€£çµè‡³å¹«åŠ©æ–‡ä»¶',
                relLicense:'ç‰ˆæ¬Š: é€£çµè‡³ç‰ˆæ¬Šå®£å‘Šé é¢',
                relNext:'ä¸‹ä¸€æ­¥: é€£çµè‡³ä¸‹ä¸€å€‹è¢«é¸æ“‡çš„é é¢',
                relNofollow:'ä¸è¿½è¹¤: é€£çµè¨­ç½®å–æ¶ˆè¿½è¹¤é¸é …, ä¾‹å¦‚ä»˜è²»é é¢, ä¸¦ä¸”ç¦æ­¢æœå°‹å¼•æ“Žè¿½è¹¤è©²é é¢',
                relNoreferrer:'NoReferrer: æŒ‡å®šç™¼é€æ™‚å–æ¶ˆ HTTP çš„é–‹é ­',
                relPrefetch:'é å­˜: æŒ‡å®šè©²é é¢å•Ÿç”¨é å­˜ç€è¦½',
                relPrev:'ä¸Šä¸€æ­¥: ä¸Šä¸€å€‹è¢«é¸æ“‡çš„é é¢',
                relSearch:'æœå°‹: é€£è‡³æœå°‹æ–‡ä»¶',
                relTag:'æ¨™ç±¤: ç‚ºè©²æ–‡ä»¶è¨­å®šæ¨™ç±¤(é—œéµå­—)'
            }
        },
        'it-IT':{ /* Italian */
            imageAttributes:{
                ...
                title:'Titolo',
                src:'Fonte',
                srcHelp:'elezione di un\'immagine sostituirÃ  immagine esistente con un inline Immagine.',
                alt:'Alt',
                class:'Classe',
        ...
        'de-DE':{ /* German */
            imageAttributes:{
                ...
                title:'Titel',
                src:'Quelle',
                srcHelp:'Wenn Sie ein Bild auswÃ¤hlen, wird das bestehende Bild durch ein Inlined Image ersetzt.',
                alt:'Alt Tag',
                class:'CSS Klasse',
        ...
        'tr-TR':{ /* Turkish */
            imageAttributes:{
                dialogTitle:'Resim Ã–zellikleri',
                tooltip:'Resim Ã–zellikleri',
                pluginImageTitle:'Resim Ã–zellikleri',
                pluginLinkTitle:'BaÄŸlantÄ± Ã–zellikleri',
                title:'BaÅŸlÄ±k',
                src:'Kaynak',
                srcHelp:'Bir gÃ¶rÃ¼ntÃ¼yÃ¼ seÃ§mek, var olan resmi Inlined Image ile deÄŸiÅŸtirecektir.',
                alt:'Alt. Metin',
                class:'SÄ±nÄ±f',
                classSelect:'SÄ±nÄ±f SeÃ§in',
                style:'Stil',
                role:'Rol',
                href:'URL',
                target:'Hedef',
                linkClass:'BaÄŸlantÄ± SÄ±nÄ±fÄ±',
                linkRole:'Rol',
                rel:'BaÄŸlantÄ± Ä°liÅŸkisi(Rel)',
                relBlank:'Ä°liÅŸki Ã¶zelliÄŸini kullanma',
                relAlternate:'Alternatif: Belgenin farklÄ± bir versiyonuna baÄŸlantÄ±',
                relAuthor:'Yazar: Belgenin yazarÄ±na baÄŸlantÄ±',
                relBookmark:'Yer Ä°mi: Yer Ä°mi eklemek iÃ§in kalÄ±cÄ± adres',
                relHelp:'YardÄ±m: YardÄ±m dÃ¶kÃ¼manÄ±na giden baÄŸlantÄ±',
                relLicense:'Lisans: Belgenin telif hakkÄ± bilgisine baÄŸlantÄ±',
                relNext:'Sonraki: SÄ±radaki belgeye giden baÄŸlantÄ±',
                relNofollow:'Takip Etme (NoFollow): Arama motorlarÄ±nÄ±n bu baÄŸlantÄ±yÄ± takip etmemesini saÄŸlar',
                relNoreferrer:'ReferanssÄ±z (NoReferrer): TarayÄ±cÄ±nÄ±n bu baÄŸlantÄ±ya referans adresi gÃ¶ndermemesi gerektiÄŸini belirtir',
                relPrefetch:'Ã–nBellek(PreFetch): Hedef baÄŸlantÄ±nÄ±n Ã¶n belleÄŸe alÄ±nmasÄ± gerektiÄŸini belirtir',
                relPrev:'Ã–nceki: Ã–nceki belgeye giden baÄŸlantÄ±',
                relSearch:'Arama: Belge iÃ§in bir arama aracÄ±na baÄŸlantÄ± olduÄŸunu belirtir.',
                relTag:'Etiket: Belge iÃ§in bir etiket olduÄŸunu belirtir'
            }
        }
    });
