...
class Manage extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->lang->load('countries_manage', $this->_site_lang);
    ...
    public function index()
    {
        ...
        list($list, $total) = $this->Country->get_all_by_filter($filter, $limit, $start_index);
    ...
    public function delete($id = null)
    {
        ...
        if (isset($_POST['is_delete']) && isset($_POST['ids']) && !empty($_POST['ids'])) {
            ...
            $list_delete = $this->Country->where('country_id', $ids)->get_all();
            ...
            try {
                foreach($list_delete as $value) {
                    $this->Country->delete($value['country_id']);
                }
        ...
        $list_delete = $this->Country->where('country_id', $delete_ids)->get_all();
        if (empty($list_delete)) {
            json_output(['status' => 'ng', 'msg' => lang('error_token')]);
        }
    ...
    public function publish()
    {
        ...
        $item_edit = $this->Country->get($id);
        if (empty($item_edit)) {
            json_output(['status' => 'ng', 'msg' => lang('error_empty')]);
        }

        $item_edit['published'] = !empty($_POST['published']) ? STATUS_ON : STATUS_OFF;
        if (!$this->Country->update($item_edit, $id)) {
