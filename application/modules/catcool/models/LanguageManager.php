...
use catcool\models\Language;

class LanguageManager extends My_DModel
{
    const ENTITY_NAME = 'catcool\models\Language';

    //query su dung trong support tool
    private $_queries = [
        'find_by_all' => 'SELECT e FROM __TABLE_NAME__ e WHERE e.name LIKE :name OR e.code LIKE :code ORDER BY e.id DESC',
    ...
    public function get_all_by_filter($filter = null, $limit = 0, $offset = 0)
    {
        ...
        $filter['code']    = empty($filter['code']) ? '%%' : '%'.$filter['code'].'%';
