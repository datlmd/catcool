<li class="dd-item" data-id="{$menu.menu_id}">
	<div class="dd-handle">
		...
		<div class="dd-nodrag btn-group ml-auto">
			...
			<a href="{base_url($manage_url)}/edit/{$menu.menu_id}" class="btn btn-sm btn-outline-light" {if count($list) > 1}data-toggle="tooltip" data-placement="top" title="" data-original-title="{lang('button_edit')}"{/if}><i class="fas fa-edit"></i></a>
