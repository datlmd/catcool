						...
						<table class="table table-striped table-hover table-bordered second">
							...
							{foreach $list as $item}
								<tr>
									...
									<td>{anchor("$manage_url/edit/`$item.dummy_id`", htmlspecialchars($item.detail.name, ENT_QUOTES,'UTF-8'), 'class="text-primary"')}</td>
									<td>{htmlspecialchars($item.detail.description, ENT_QUOTES,'UTF-8')}</td>
