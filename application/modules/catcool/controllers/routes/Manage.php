...
class Manage extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        theme_load('routes/manage/list', $this->data);
    }
    ...
    public function add()
    {
        ...
        theme_load('routes/manage/add', $this->data);
    }
    ...
    public function edit($id = null)
    {
        ...
        theme_load('routes/manage/edit', $this->data);
    }
    ...
    public function delete($id = null)
    {
        ...
        theme_load('routes/manage/delete', $this->data);
    }
}
