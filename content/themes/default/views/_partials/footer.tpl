<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?><div class="navbar navbar-default navbar-fixed-bottom">
	<div class="container">
		<p class="navbar-text pull-left">&copy; {date('Y')} - <?php $site_title; ?> <a href="https://github.com/bkader" target="_blank">@bkader</a> Page rendered in: <strong>___theme_time___</strong> seconds. Theme render time: <strong>{$theme_time}</strong>.
		</p>
