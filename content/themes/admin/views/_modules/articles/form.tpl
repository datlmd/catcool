                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-sm-6 pr-3 text-right">
                                                                {lang("text_seo_lenght_input")} <span id="seo_meta_title_{$language.id}_length" data-target="input-meta-title-{$language.id}" class="seo-meta-length"></span>/70
                                                            </div>
                                                        </div>
                                                        <input type="text" name="manager_description[{$language.id}][meta_title]" data-seo-id="seo_meta_title_{$language.id}" onkeyup="Catcool.setContentSeo(this);" value='{set_value("manager_description[`$language.id`][meta_title]", $edit_data.details[$language.id].meta_title)}' placeholder="{$edit_data.details[$language.id].meta_title}" id="input-meta-title-{$language.id}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="manager_description[{$language.id}][slug]" data-is-slug="true" data-seo-id="seo_meta_url_{$language.id}" onkeyup="Catcool.setContentSeo(this);"  value='{set_value("manager_description[`$language.id`][slug]", $edit_data.details[$language.id].slug)}' placeholder="{$edit_data.details[$language.id].slug}" id="input-slug-{$language.id}" describedby="input_group_slug" class="form-control form-control-lg pl-0 border-left-0 {if !empty($errors["slug_`$language.id`"])}is-invalid{/if}">
                                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-sm-6 pr-3 text-right">
                                                                {lang("text_seo_lenght_input")} <span id="seo_meta_description_{$language.id}_length" data-target="input-meta-description-{$language.id}" class="seo-meta-length"></span>/320
                                                            </div>
                                                        </div>
                                                        <textarea name="manager_description[{$language.id}][meta_description]" cols="40" data-seo-id="seo_meta_description_{$language.id}" onkeyup="Catcool.setContentSeo(this);" rows="2" id="input-meta-description-{$language.id}" type="textarea" class="form-control">{set_value("manager_description[`$language.id`][meta_description]", $edit_data.details[$language.id].meta_description)}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
