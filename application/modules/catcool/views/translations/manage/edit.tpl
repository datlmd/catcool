                ...
                <div class="card-body">
                    ...
                    {form_open(uri_string(), ['id' => 'edit_validationform'])}
                        <div class="form-group row">
                            {lang('lang_key_label', 'lang_key_label', ['class' => $class_colum_lable])}
                            <div class="{$class_colum_input}">
                                {form_input($lang_key)}
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('lang_value_label', 'lang_value_label', ['class' => $class_colum_lable])}
                            <div class="{$class_colum_input}">
                                {form_input($lang_value)}
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('lang_id_label', 'lang_id_label', ['class' => $class_colum_lable])}
                            <div class="{$class_colum_input}">
                                {form_input($lang_id)}
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('module_id_label', 'module_id_label', ['class' => $class_colum_lable])}
                            <div class="{$class_colum_input}">
                                {form_input($module_id)}
                            </div>
                        </div>
                        <div class="form-group row">
